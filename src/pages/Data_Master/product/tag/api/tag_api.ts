...
export const ADD_BRAND = API_URL + API_VERSION +   "/product-tag/create-product-tag";
export const GET_ALL_BRAND = API_URL + API_VERSION +   "/product-tag/get-all-product-tag";
export const GET_ONE_BRAND = API_URL + API_VERSION +   "/product-tag/get-product-tag";
export const UPDATE_BRAND = API_URL + API_VERSION +   "/product-tag/update-product-tag";
export const UPDATE_STATUS = API_URL + API_VERSION +   "/product-tag/update-status-tag";
export const DELETE_BRAND = API_URL + API_VERSION +   "/product-tag/delete-product-tag";
export const GET_BRAND_OPTIONS = API_URL + API_VERSION +   "/product-tag/get-tag-options";
