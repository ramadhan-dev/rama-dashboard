...
export const ADD_BRAND = API_URL + "/product-type/create-product-type";
export const GET_ALL_BRAND = API_URL + "/product-type/get-all-product-type";
export const GET_ONE_BRAND = API_URL + "/product-type/get-product-type";
export const UPDATE_BRAND = API_URL + "/product-type/update-product-type";
export const UPDATE_STATUS = API_URL + "/product-type/update-status-type";
export const DELETE_BRAND = API_URL + "/product-type/delete-product-type";
export const GET_BRAND_OPTIONS = API_URL + "/product-type/get-type-options";
