...
export const ADD_BRAND = API_URL + "/product-status/create-product-status";
export const GET_ALL_BRAND = API_URL + "/product-status/get-all-product-status";
export const GET_ONE_BRAND = API_URL + "/product-status/get-product-status";
export const UPDATE_BRAND = API_URL + "/product-status/update-product-status";
export const UPDATE_STATUS = API_URL + "/product-status/update-status-status";
export const DELETE_BRAND = API_URL + "/product-status/delete-product-status";
export const GET_BRAND_OPTIONS = API_URL + "/product-status/get-status-options";
