...
const AddDistrictComponents = lazy(() => import("./components/AddDistrictComponents"));
const DownloadButtonComponent = lazy(() => import("#/Common/Components/Button/DownloadButtonComponent"));
const DistrictTableComponent = lazy(() => import("./components/DistrictTableComponent.tsx"));
