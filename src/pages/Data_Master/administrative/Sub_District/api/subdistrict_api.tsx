...
export const ADD_SUBDISTRICT = API_URL + API_VERSION +   "/sub-district/create-sub-district";
export const GET_ALL_SUBDISTRICT = API_URL + API_VERSION +   "/sub-district/get-all-sub-district";
export const GET_ONE_SUBDISTRICT = API_URL + API_VERSION +   "/sub-district/get-sub-district";
export const UPDATE_SUBDISTRICT = API_URL + API_VERSION +   "/sub-district/update-sub-district";
export const DELETE_SUBDISTRICT = API_URL + API_VERSION +   "/sub-district/delete-sub-district";
