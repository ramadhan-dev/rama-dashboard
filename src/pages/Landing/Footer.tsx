					...
					<div className="relative z-10 grid grid-cols-12 gap-5 xl:grid-cols-12">
						...
						<div className="col-span-12 md:col-span-6 lg:col-span-12 xl:col-span-4">
							<form action="#!" className="relative mb-6">
								<input type="email" id="subscribeInput" className="py-3 ltr:pr-40 rtl:pl-40 bg-slate-700/60 dark:bg-zink-600/40 form-input text-slate-200 border-slate-700 dark:border-zink-500 focus:outline-none focus:border-custom-500 dark:focus:border-custom-500 placeholder:text-slate-500 dark:placeholder:text-zink-200 backdrop-blur-md" autoComplete="off" placeholder="ramadhan.dev@gmail.com" required />
								<button type="submit" className="btn-primary ltr: right-1 rtl:left-1">Subscribe Now</button>
							</form>
