				...
				<div className="container 2xl:max-w-[87.5rem] px-4 mx-auto">
					<div className="relative z-10 grid grid-cols-12 gap-5 xl:grid-cols-12">
						...
						<div className="col-span-12 md:col-span-6 lg:col-span-12 xl:col-span-4">
							<form action="#!" className="relative mb-6 divide-y">
								<input type="email" id="subscribeInput" className="py-3 ltr:pr-40 rtl:pl-40 bg-slate-700/60 form-input text-slate-200 border-slate-700 focus:outline-none focus:border-custom-500 placeholder:text-slate-500 backdrop-blur-md" autoComplete="off" placeholder="ramadhan.dev@gmail.com" required />
