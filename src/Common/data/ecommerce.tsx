...
const generateData = () => {
	let data:number[] = []
	_.map(_.range(0, 12), () => {
		const numb =  faker.number.int({ min: 0, max: 100 })
		data.push(numb)
	})
	return data
}
...
export { ListViewData, OrderListData, SellersData, ProductGridViewData, ShoppingCartData, ProductReviewsData, CountersData, OrderStatisticData, SalesRevenueData };
