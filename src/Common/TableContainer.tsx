...
interface TableContainerProps {
  ...
  SearchPlaceholder?: string;
	onClickPagination:(pageIndex:number, pageSize:number) => void
}
    ...
    <Fragment>
      ...
      <div className="grid grid-cols-12 lg:grid-cols-12 gap-3">
        ...
        <div className="self-center col-span-12 lg:col-span-6 lg:place-self-end">
          {isGlobalFilter &&
						<label><span className="pr-5">Search: </span><DebouncedInput
              value={globalFilter ?? ''}
