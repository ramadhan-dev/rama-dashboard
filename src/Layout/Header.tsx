...
const Header = ({ handleToggleDrawer }: any) => {
	...
	const profile = useSelector((state: any) => state?.masterState?.Profile);

	const { user } = profile;
	const { layoutSidebarSizeType, layoutType } = Layout;
