...
module.exports = plugin(function ({ addComponents, theme }) {
    addComponents({
        ...
        '.flatpickr-months': {
            '@apply bg-transparent flex items-center h-12 justify-center': {},

            '.flatpickr-month': {
                '@apply text-slate-500 dark:text-zink-200 dark:fill-zink-500 fill-slate-600 h-12': {},

                '.flatpickr-current-month': {
                    '@apply text-15 h-auto pt-0 flex items-center bottom-0': {},
            ...
            '.flatpickr-prev-month, .flatpickr-next-month': {
                '@apply text-slate-500 fill-slate-500 size-8 flex items-center hover:text-slate-600 dark:hover:text-zink-100 border !border-slate-200 dark:!border-zink-500 dark:text-zink-200 rounded-md': {},

                '&.flatpickr-prev-month': {
										'top': '10px !important',
										'left': '3px !important',
                    '@apply left-10 text-custom-100' : {},
                },
