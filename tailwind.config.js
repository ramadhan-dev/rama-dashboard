...
export default {
  ...
  plugins: [
    ...
    // require('./plugins/colorpicker.ts'),  // instead react-color picker
    require('./plugins/ckeditor.ts'),
    require('./plugins/apexcharts.ts'),
    require('./plugins/maps.ts'), // google-maps-react
    // require('./plugins/multijs.ts'), // instead react-dual-listbox
